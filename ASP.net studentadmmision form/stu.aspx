<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stu.aspx.cs" Inherits="stu.stu" %>
...
<body>
    ...
    <div style="background-color:lime">
            <asp:Repeater ID="repeater2" runat="server" DataSourceID="SqlDataSource1">
                ...
                <ItemTemplate>
                    <table style="width:100%; border:solid 2px;background-color:wheat">
            <tr>
            ...
            <tr>
                ...
                <FooterTemplate>
                    <table style="background-color:lightcyan;border:solid 2px;color:red">
                        <tr>
                            <td>
                                 @developed by Manasa
                            </td>
